...
import utils.losses
from model.MambaLIE import MambaLIE
import argparse
parser = argparse.ArgumentParser(description='Hyper-parameters for MambaLIE')
...
model_restored = MambaLIE(inp_channels=3,out_channels=3,dim = 16,num_blocks = [1,2,4,8],num_refinement_blocks = 2,heads = [1,2,4,8],ffn_expansion_factor = 2.66,bias = False,LayerNorm_type = 'WithBias',attention=True,feat=40,skip = False)
